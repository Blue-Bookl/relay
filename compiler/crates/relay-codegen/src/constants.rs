...
pub struct CodegenConstants {
    ...
    pub server_object_operations: StringKey,
    pub server_weak: StringKey,
...
pub static CODEGEN_CONSTANTS: LazyLock<CodegenConstants> = LazyLock::new(|| CodegenConstants {
    ...
    server_object_operations: "serverObjectOperations".intern(),
    server_weak: "ServerWeak".intern(),
